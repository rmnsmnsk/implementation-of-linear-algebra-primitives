...
void test_sort_matrix() {
    ...
    assert(sorted->rows_indices[0] == 0 && sorted->coll_indices[0] == 0 && fabs(sorted->values[0] - 2.0) < 1e-5);
    assert(sorted->rows_indices[1] == 0 && sorted->coll_indices[1] == 2 && fabs(sorted->values[1] - 1.0) < 1e-5);
    assert(sorted->rows_indices[2] == 1 && sorted->coll_indices[2] == 0 && fabs(sorted->values[2] - 3.0) < 1e-5);
    assert(sorted->rows_indices[3] == 2 && sorted->coll_indices[3] == 1 && fabs(sorted->values[3] - 5.0) < 1e-5);
...
void test_multiplication_matrix_and_vector() {
    ...
    assert(result->rows_indices[0] == 0 && result->coll_indices[0] == 0 && fabs(result->values[0] - 8.0) < 1e-5);
    assert(result->rows_indices[1] == 1 && result->coll_indices[1] == 0 && fabs(result->values[1] - 14.0) < 1e-5);
...
void test_multiplication_vector_and_matrix() {
    ...
    assert(result->rows_indices[0] == 0 && result->coll_indices[0] == 0 && fabs(result->values[0] - 10.0) < 1e-5);
    assert(result->rows_indices[1] == 0 && result->coll_indices[1] == 1 && fabs(result->values[1] - 13.0) < 1e-5);
...
void test_coo_map2() {
    ...
    assert(result->nnz == 5);
    assert(result->rows_indices[0] == 0 && result->coll_indices[0] == 0 && fabs(result->values[0] - 6.0) < 1e-5);
    assert(result->rows_indices[1] == 0 && result->coll_indices[1] == 1 && fabs(result->values[1] - 2.0) < 1e-5);
    assert(result->rows_indices[2] == 1 && result->coll_indices[2] == 1 && fabs(result->values[2] - 9.0) < 1e-5);
    assert(result->rows_indices[3] == 1 && result->coll_indices[3] == 2 && fabs(result->values[3] - 7.0) < 1e-5); 
    assert(result->rows_indices[4] == 2 && result->coll_indices[4] == 2 && fabs(result->values[4] - 12.0) < 1e-5);
